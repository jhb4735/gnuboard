...
<div id="wrapper">
	<aside id="aside">
	    ...
	    <div id="aside_ct">
	        <div class="short_cut">
	            <ul>
	                <li class="f_short_cut"><strong><a href="#">나의 정보 수정</a></strong></li>
	                <li><strong><a href="http://52.79.224.65/bbs/board.php?bo_table=free">내 공간</a></strong></li>
	                <li><strong><a href="#">두더지 잡기</a></strong></li>
	            </ul>
	        </div>
	        <div class="aside_lt">
	            <?php
